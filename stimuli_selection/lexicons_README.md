# Lexicons / Norms (local files)

This project uses two Polish lexical resources that are not committed to Git due to licensing/distribution constraints.
Download them from their original sources and place them here as:
